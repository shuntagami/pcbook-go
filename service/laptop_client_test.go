...
import (
	...
	"github.com/shuntagami/pcbook-go/sample"
	"github.com/shuntagami/pcbook-go/serializer"
...
// startTestLaptopServer create the gRPC server by calling grpc.NewServer() function, then register the laptop service server on that gRPC server
...
// newTestLaptopClient return a new laptop-client
...
// requireSameLaptop compare two laptops by serialisign the objects to JSON
